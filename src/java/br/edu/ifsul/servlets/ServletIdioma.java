 ...
 * @author jorge
 */
@WebServlet(name = "ServletIdioma", urlPatterns = {"/idioma/ServletIdioma"})
public class ServletIdioma extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acao == null){
            ...
            dao.setObjetoSelecionado(new Idioma());
            dao.setMensagem("");
            tela = "formulario.jsp";
            ...
            Integer id = Integer.parseInt(request.getParameter("id"));
            Idioma objeto = dao.localizar(id);
            if (objeto != null){
                dao.remover(objeto);
                tela = "listar.jsp";
            }
            ...
            dao.getObjetoSelecionado().setSigla(request.getParameter("sigla"));
        ...
        request.getSession().setAttribute("idiomaDao", dao);
